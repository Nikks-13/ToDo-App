...
const TaskCreator = ({modal,toggle,save}) => {
    ...
    return (
      ...
      }} toggle={toggle}>Create Your Todo</ModalHeader>
            <ModalBody>
               <Form ref={form}>
                   <Div >
                       <Label>Task Name:</Label>
                       <Input type="text"  placeholder="Write your Task !"  value={taskname} onChange={handleChange} name="taskName"/>
                   </Div>
                   <Div>
                       <Label>Description:</Label>
                       <Textarea rows="5"  placeholder="Write a Description about Task!"value={description} onChange={handleChange} name="description"></Textarea>
                   </Div>
               </Form>              
            </ModalBody>
            <ModalFooter>
                <Button1 className="createBtn" onClick={saveTask}>Create</Button1>
